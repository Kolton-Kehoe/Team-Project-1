...
template<class T>
void Polynomial_Addition<T>::add() {
    Polynomial_Addition<Term> list;
}
...
private:
    ...
    //const Polynomial_Addition<T>* parent;
    int coefficient;
    int exponent;
...
template<class T>
Polynomial_Addition<T>::Term::Term(int coefficient, int exponent) :
